...
\item Revision 0.4 {\footnotesize(rXXXX)} --
  \subitem Define MPQ register map, record semantics, and layer interrupt
  interface
  \subitem Reduce maximum memory message length from $2^{20}$ to $2^{16}$,
  reserving recovered bits
