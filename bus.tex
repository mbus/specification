...
\item Revision 0.5 {\footnotesize(r2995)} -- Feb 10, 2012
\subitem Add Priority Arbitration
\subitem Reset to Idle requires three 1's, not two

\item Revision 0.5 {\footnotesize(r2988)} -- Feb 10, 2012
...
Some attempts at using longer Message~End~Sequence (MES),
Message~Acknowledgement (ACK), and Bus~Reset (RST) signals to provide stronger
guarantees in the face of transient faults. While some resulted in small
improvements, none were sufficiently powerful to justify the overhead applied
