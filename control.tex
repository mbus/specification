...
prepare a \nameref{cmd:query-response} when this message is received.
...
%
  \begin{subfigure}{.8\linewidth}
    ...
    \begin{bytefield}[bitwidth=1.25em]{32}
      \bitheader{0-31} \\
      \bitbox{28}{0000 0000 0000 0000 0000 0000 0001}
...
\paragraph{Query/Enumerate Response (Data \texttt{0x1xxxxxxx})}
