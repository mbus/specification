...
\hl{Thought: Should controller address actually exist? Or should control
messages all be put on a broadcast channel? Is there any type of control
message that wouldn't make more sense alerting every node to the change
implicitly?}
