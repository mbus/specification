...
This message announces that an interrupt has occured on this member node. The
semantics of a \bus level interrupt dictacte that an interrupt must be
explicitly cleared. A member node {\bf must not} genereate another level
