...
%
  \begin{subfigure}{.8\linewidth}
    ...
    \begin{bytefield}[bitwidth=1.25em]{32}
      \bitheader{0-31} \\
      \bitbox{4}{0000}
      \bitbox{28}{ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ}
    \end{bytefield}
    \caption{Data}
  \end{subfigure}
\end{figure}
...
%
  \begin{subfigure}{.8\linewidth}
    ...
    \begin{bytefield}[bitwidth=1.25em]{32}
      \bitheader{0-31} \\
      \bitbox{4}{0010}
      \bitbox{24}{ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ}
      \bitbox{4}{Short Prefix}
    \end{bytefield}
    \caption{Data}
  \end{subfigure}
...
%
  \begin{subfigure}{.8\linewidth}
    ...
    \begin{bytefield}[bitwidth=1.25em]{32}
      \bitheader{0-31} \\
      \bitbox{4}{0011}
      \bitbox{24}{ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ}
      \bitbox{4}{Short Prefix}
    \end{bytefield}
    \caption{Data}
  \end{subfigure}
...
%
  \begin{subfigure}{.8\linewidth}
    ...
    \begin{bytefield}[bitwidth=1.25em]{32}
      \bitheader{0-31} \\
      \bitbox{4}{0000}
      \bitbox{28}{ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ ZZZZ}
    \end{bytefield}
    \caption{Data}
  \end{subfigure}
\end{figure}
...
This message instructs selected nodes to sleep. The bottom 16~bits of data are
