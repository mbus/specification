...
\subsubsection{Reg \#232: Register Message Control}
\label{cmd:conf-reg-ctrl}

\begin{bytefield}{8}
  \bitheader{0-7} \\
  \colorbitbox{lightgreen}{2}{11}
  \colorbitbox{lightergreen}{6}{101000}
\end{bytefield}
~
\begin{bytefield}{24}
  \bitheader{0-23} \\
...
\subsubsection{Reg \#233: Bulk Memory Message Control}
\label{cmd:conf-mem-ctrl}

\begin{bytefield}{8}
  \bitheader{0-7} \\
  \colorbitbox{lightgreen}{2}{11}
  \colorbitbox{lightergreen}{6}{101001}
\end{bytefield}
~
\begin{bytefield}{24}
  \bitheader{0-23} \\
