...
\begin{bytefield}[bitwidth=0.5em]{24}
  ...
  \begin{rightwordgroup}{\begin{sideways}\small Tie to {\tt 0}\end{sideways}}
    \memsectionhuge{\#192}{\#222}{16}{Reserved}
  \end{rightwordgroup}\\
  \begin{rightwordgroup}{\begin{sideways}\small Retentive\end{sideways}}
    \bitbox[]{8}{\tt\#223}\wordbox{1}{\proto Configuration}\\
    \memsection{\#224}{\#239}{8}{Memory Stream Configuration Registers}\\
    \memsection{\#240}{\#247}{4}{Status Registers\\{\color{red}Read Only}}
  \end{rightwordgroup}\\
...
\begin{mdframed}[backgroundcolor=lightercyan]
  ...
  \begin{minipage}[b]{.6\linewidth}
    ...
    \begin{bytefield}{24}
      \bitheader{0-23} \\
      \bitbox{4}{0010}
      \colorbitbox{lightgray}{4}{Reserved}
    ...
    \begin{bytefield}{24}
      \bitheader{0-23} \\
      \colorbitbox{lightgray}{4}{Reserved}
      \bitbox{20}{\scriptsize Length Written-1}
    \end{bytefield}
  \end{minipage}
...
\begin{mdframed}[backgroundcolor=lightercyan]
  ...
  \begin{minipage}[b]{.6\linewidth}
    ...
    \begin{bytefield}{24}
      \bitheader{0-23} \\
      \colorbitbox{lightgray}{4}{Reserved}
      \bitbox{20}{\scriptsize Length Read-1}
    \end{bytefield}
...
\paragraph{Memory Bulk Write}
\recordMemBulkWrite

\paragraph{Memory Read}
\recordMemRead

\paragraph{Memory Stream Write}
\recordMemStreamWrite
