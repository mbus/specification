...
\noindent\makebox[\textwidth]{%
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      ...
      Bus  & D{}{12D{Data 0}}{12D{Data 1}}{12D{Data 0}}{12D{Data 1}}{12D{MES 01}}
               {12D{ACK 10}}{27D{Reset 010}} {30D{Reset 11}}D \\
      \extracode
        \begin{pgfonlayer}{background}
          \begin{scope}[semitransparent,semithick,dashed,color=red]
            \vertlines{1,7,...,71}
...
after sending a Message~End~Sequnce, a TX node should start a 5~half-bit
...
\bus does allow for arbitrary message lengths, desginers may define a maximum
