...
\noindent\makebox[\textwidth]{%
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      %       |  D1   |  D0   |  D1   |    MES        |
      %       |   ACK        ,       ,              | Reset
      Din  & L 8{1.5H} 8{1.5L} 8{1.5H} 4{1.5L} 4{1.5H}
               4{1.5H}4{1.5L} 8{1.5H} 4{1.5L}4{1.5H} 8{1.5L}6{1.5H} H \\
      CLK  & C 8{1.5C} 8{1.5C} 8{1.5C} 4{1.5C} 4{1.5C}
               4{1.5C}4{1.5C} 8{1.5C} 4{1.5C}4{1.5C} 3L3{3C}3{3C}   C \\
      Bus  & D{}{12D{Data 1}}{12D{Data 0}}{12D{Data 1}}{12D{MES 01}}
               {12D{ACK 10}}{12D{ACK 11}}{12D{ACK 01}}  {45D{Reset}}D \\
      \extracode
        \begin{pgfonlayer}{background}
          \begin{scope}[semitransparent,semithick,dashed,color=red]
            \vertlines{1,7,...,83}
