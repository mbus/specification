...
\begin{subfigure}{\textwidth}
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      ...
      Din  & L 0.2L8{2L} 8{2H}  8{2L} 15{2H} 1.8H H \\
      Dout & L 0.4L8{2L} 8{2H}  8{2L} 15{2H} 1.6H H \\
      \\
      Din  & L 0.6L8{2L} 8{2H}  8{2L} 15{2H} 1.4H H \\
      Dout & L 0.8L8{2L} 8{2H}  8{2L} 15{2H} 1.2H H \\
      \\
      Din  & L 1.0L8{2L} 8{2H}  8{2L} 15{2H} 1.0H H \\
      Dout & L 1.2L8{2L} 8{2H}  8{2L} 15{2H} 0.8H H \\
      \\
      Din  & L 1.4L8{2L} 8{2H}  8{2L} 15{2H} 0.6H H \\
      Dout & L 0.0L8{2L} 8{2H}  8{2L} 15{2H} 2.0H H \\
      CLK  & L 4L  3{4C} 4{4C}  4{4C}  8{4C}      H \\
      ~~~  & L     8{2C} 8{2C}  8{2C} 16{2C}      C \\
      \extracode
        \begin{pgfonlayer}{background}
          \begin{scope}[semitransparent,semithick]
            \pgfmathparse{\twidth-1}
        ...
        \begin{scope}
          ...
          \node [rotate=45] at (\base+48, 0) {Reset$_{1}$-D};
          \node [rotate=45] at (\base+56, 0) {Reset$_{1}$-L};
          \node [rotate=45] at (\base+64, 0) {Reset$_{2}$-D};
          \node [rotate=45] at (\base+72, 0) {Reset$_{2}$-L};
        \end{scope}
        \begin{scope}
          ...
          \node [rotate=45] at (\base+48, 0) {R1-I$_{1}$-D};
          \node [rotate=45] at (\base+56, 0) {R1-I$_{1}$-L};
          \node [rotate=45] at (\base+64, 0) {R1-I$_{2}$-D};
          \node [rotate=45] at (\base+72, 0) {R1-I$_{2}$-L};
