...
\noindent\makebox[\textwidth]{%
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      ...
      Din  & L 8{1.5H} 8{1.5L} 8{1.5H} 4{1.5H} 4{1.5L}
      ...
      Bus  & D{}{12D{Data 1}}{12D{Data 0}}{12D{Data 1}}{12D{MES 10}}
      ...
      \extracode
        ...
        \begin{scope}
          ...
          \node [rotate=45] at (106,0) {Reset (D)};
          \node [rotate=45] at (112,0) {Reset (L)};
          \node [rotate=45,color=black] at (118,0) {Idle (L)};
        \end{scope}
    \end{tikztimingtable}
}
