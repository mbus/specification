...
\begin{subfigure}{\textwidth}
    \centering
    \huge {\bf TRY MES 0111, ACK 1001, RST 01011:}

    \tiny
    \begin{tikztimingtable}[timing/slope=.3,timing/wscale=1.0]
      %       |    D0     || D1  ||   D0   {}  RD0
      Din  & L 0.8L  4L12L  4H12H2.2LXX3H4H  4L            \\
      Dout & L 0.0L  4L12L  4H12H  4L X3H4H  4L            \\
      ~~~~ & D{}{16D{Data 0}}{16D{Data 1}}{56D{Data 0}}{0D{Error (Forwarding)}}{28D{Reset}}D
      \\
      \\
      Din  & L 0.0L  4L11LXX3H11HXX3L  4H4H  4L      \\
      Dout & L 0.0L  4L11LXX3H11HXX3L  4H4H  4L      \\
      ~~~~ & {5D{Data 0}}{32D{End Sequence}}{28D{Acknowledgement Attempt}}{32D{Error (Forwarding)}}{20D{Reset}}D \\
      %\\
      Din  & L 0.5L  4L12L  4H12H  4L  4H4H  4L      \\
      Dout & L 0.5L  4L12L  4H12H  4L3.5H4H  4L         \\
      ...
      \extracode
        ...
        \end{scope}
    \end{tikztimingtable}
    \caption{Transmitter is sending data bits 0, 1, 0 ({\tt 001100}).
    }
