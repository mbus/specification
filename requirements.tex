...
\begin{subfigure}{\textwidth}
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      %       | ACK 1      0      |ACK/RST 0  1   | RST 0 11
      Din  & H 1.0H4{2H} 3{2L}1.0L 0.2L8{2L} 8{2H}  8{2L} 7{2H} 1.8H H \\
      Dout & H 1.2H4{2H} 3{2L}0.8L 0.4L8{2L} 8{2H}  8{2L} 7{2H} 1.6H H \\
      \\
      Din  & H 1.4H4{2H} 3{2L}0.6L 0.6L8{2L} 8{2H}  8{2L} 7{2H} 1.4H H \\
      Dout & H 0.0H4{2H} 3{2L}2.0L 0.8L8{2L} 8{2H}  8{2L} 7{2H} 1.2H H \\
      \\
      Din  & H 0.2H4{2H} 3{2L}1.8L 1.0L8{2L} 8{2H}  8{2L} 7{2H} 1.0H H \\
      Dout & H 0.4H4{2H} 3{2L}1.6L 1.2L8{2L} 8{2H}  8{2L} 7{2H} 0.8H H \\
      \\
      Din  & H 0.6H4{2H} 3{2L}1.4L 1.4L8{2L} 8{2H}  8{2L} 7{2H} 0.6H H \\
      Dout & H 0.8H4{2H} 3{2L}1.2L 0.0L8{2L} 8{2H}  8{2L} 7{2H} 2.0H H \\
      CLK  & C     4{2C} 4{2C}   4L3{4C} 4{4C}  4{4C} 4{4C}      H \\
      ~~~  & C     4{2C} 4{2C}     8{2C} 8{2C}  8{2C} 8{2C}      C \\
      \extracode
        \begin{pgfonlayer}{background}
          \begin{scope}[semitransparent,semithick]
            \vertlines{1,17,...,16}
          ...
          \begin{scope}[semitransparent,yellow]
            ...
            % Clk
            \filldraw ( 0,-20.5) rectangle (17,-22.5);
          \end{scope}
          \begin{scope}[cyan,opacity=.25]
            \filldraw   (17,-18.5) rectangle (\twidth-1,-22.5);
          \end{scope}
        \end{pgfonlayer}
        \begin{scope}
          [font=\sffamily\small,shift={(-3.0em,-0.5)},anchor=east,color=blue]
        ...
        \begin{scope}
          ...
          \draw
            ...
            (0,0) node[] (a) {}
            (60,0) node[] (c) {};
          \node[right=16 of a] (b) {Acknowledgement (10,010)};
          \draw[->] (b.west) -- (a.east);
          \draw[<-] (c.west) -- (b.east);
        \end{scope}
        \begin{scope}
...
node. We are able to gaurentee that once the introduction of faults is
removed, the \bus is reset and all nodes are phase-aligned and prepared to
communicate. We can further gaurentee that all messages are either completely
received or rejected. We cannot gaurtentee the correctness of acknowledgements
in the face of transient errors, however.
...
\noindent\makebox[\textwidth]{%
    ...
    \begin{tikztimingtable}[timing/slope=.3]
      %       |  D0   |  D1   |  D0   |  D1   |    MES 01     |
      %       |   ACK   10   | ACK/RST 01   | 0 Reset 11
      Din  & L 8{1.5L} 8{1.5H} 8{1.5L} 8{1.5H} 4{1.5L} 4{1.5H}
               4{1.5H}4{1.5L} 8{1.5L}8{1.5H} 8{1.5L}6{1.5H} H \\
      CLK  & C 8{1.5C} 8{1.5C} 8{1.5C} 8{1.5C} 4{1.5C} 4{1.5C}
               4{1.5C}4{1.5C} 3L3{3C}  4{3C}   4{3C}  3{3C} C \\
      Bus  & D{}{12D{Data 0}}{12D{Data 1}}{12D{Data 0}}{12D{Data 1}}{12D{MES 01}}
               {12D{ACK 10}}{33D{ACK/RST 010}} {12D{Reset 11}}D \\
      \extracode
        \begin{pgfonlayer}{background}
          \begin{scope}[semitransparent,semithick,dashed,color=red]
            \vertlines{1,7,...,71}
            \vertlines{76,88,100,106,112}
          \end{scope}
          \begin{scope}[semitransparent,semithick,dashed]
            \vertlines{4,10,...,75}
            \vertlines{82,94,118}
        ...
        \begin{scope}
          ...
          \node [rotate=45] at (\base+24,0) {Latch2};
          \node [rotate=45] at (\base+30,0) {Reset (D)};
          \node [rotate=45] at (\base+36,0) {Reset (L)};
          \node [rotate=45,color=black] at (\base+42,0) {Idle (L)};
        \end{scope}
    \end{tikztimingtable}
}
...
When an offset node latches the incoming {\tt 0} during its local {\sc latch2}
cycle, it will consider this a Message~End~Sequence ({\tt 10}). If the $1\phi$
...
\begin{figure}[h!]
  ...
  \begin{tikztimingtable}[timing/slope=.3,timing/wscale=1.0]
    %                                            ||||
    Din  & L 1.0L 8{2H}1.0L4{2L}LXXH1{2H}   H3.0L0.5L16L 16H 16L        \\
    Dout & L 0.0L 8{2H}2.0L4{2L}LXXH1{2H}    4.0L0.5L16L 16H 16L         \\
    ~~~~ & D{} {16D{Data 1}}{16D{Data 0}}{24D{Data 0}}{16D{Err (FWD)}}{12D{Reset}} \\
    \\
    Din  & L 0.0L 7{2H}HXXL5{2L}1.0L1{2H} XXL2.0L0.8L16L 16H 16L \\
    Dout & L 0.0L 7{2H}HXXL5{2L}    2{2H}0.5H3.5L    4L 4H 4H4.8L16H 16L  \\
    ~~~~ & 5D{} {16D{MES 10}}{20D{ACK 01}}{8D{ACK 10}}{32D{Err (FWD)}}{4D{Reset}} \\
    %\\
    Din  & L 0.8L 8{2H}    6{2L}    2{2H}    4.0L    4L 4H 4H 4L 16H 16L   \\
    Dout & L 0.8L 8{2H}    6{2L}    2{2H}    3.2L    16L 16H 16L      \\
    ...
    \extracode
      \begin{pgfonlayer}{background}
        ...
        \begin{scope}[semitransparent]
          ...
          \filldraw[yellow]    (41,-8.5) rectangle (45,-10.5);
          % CLK
      ...
      \end{scope}
  \end{tikztimingtable}
  \caption{{\em TX 1$\rightarrow$0 False MES~~}
...
If an offset node latches an incoming {\tt 1}, it will have received a {\tt
01} sequence, which is erroneous and will cause the node to enter Forwarding
(if it wasn't already) until the Reset sequence is received. An RX node may
consider explicitly resetting the bus\footnote{
  An attempt to Reset the bus will alert the control layer that there is an
out-of-phase node, and it will actually reset the bus, re-aligning the offset
node.}, but such an optimization is not mandated.

\subparagraph{TX 1$\rightarrow$Message End Sequence}
An offset node will read the leading {\tt 1} of the Message~End~Sequence as
the second half-bit of the previous Data 1. It will then read the second
half-bit of the Message~End~Sequence as a {\tt 0} half-bit and the absence of
an Acknowledgement as the second {\tt 0} half-bit. After another {\tt 0}
...
An offset node will read the leading high half-bit of the
Message~End~Sequence, generating a {\tt 01} sequence, which will cause the
node to abort the transmission and await Reset.
